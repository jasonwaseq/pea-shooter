...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/main.o: main.c  .generated_files/flags/default/5a29604a69eddc2abc3ca6048785b02e455f4b40 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/ShooterService.o: ShooterService.c  .generated_files/flags/default/b8f101a6212e873f9391a8cd0b04d53df8a93342 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ShooterService.o.d 
	@${RM} ${OBJECTDIR}/ShooterService.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -O0 -fno-common -MP -MMD -MF "${OBJECTDIR}/ShooterService.o.d" -o ${OBJECTDIR}/ShooterService.o ShooterService.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
${OBJECTDIR}/ShooterEventChecker.o: ShooterEventChecker.c  .generated_files/flags/default/9ffdbc89fe9db9b28fd773906174a1477298b09d .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ShooterEventChecker.o.d 
	@${RM} ${OBJECTDIR}/ShooterEventChecker.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -O0 -fno-common -MP -MMD -MF "${OBJECTDIR}/ShooterEventChecker.o.d" -o ${OBJECTDIR}/ShooterEventChecker.o ShooterEventChecker.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/main.o: main.c  .generated_files/flags/default/c01940c99e55026dba10535c8e890b5ae04ab712 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/main.o.d 
	@${RM} ${OBJECTDIR}/main.o 
...
${OBJECTDIR}/ShooterService.o: ShooterService.c  .generated_files/flags/default/1e6abcfc81aa4e4c5fd097e16808f731622b648c .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ShooterService.o.d 
	@${RM} ${OBJECTDIR}/ShooterService.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -O0 -fno-common -MP -MMD -MF "${OBJECTDIR}/ShooterService.o.d" -o ${OBJECTDIR}/ShooterService.o ShooterService.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
${OBJECTDIR}/ShooterEventChecker.o: ShooterEventChecker.c  .generated_files/flags/default/d79e8b8fe3ff3b39b9e1f4c8680c5c1f0d8f9681 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ShooterEventChecker.o.d 
	@${RM} ${OBJECTDIR}/ShooterEventChecker.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -O0 -fno-common -MP -MMD -MF "${OBJECTDIR}/ShooterEventChecker.o.d" -o ${OBJECTDIR}/ShooterEventChecker.o ShooterEventChecker.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
