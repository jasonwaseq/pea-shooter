...
${OBJECTDIR}/main.o: main.c  .generated_files/flags/default/db5911b4fa96891b2a80ff0dd328638f466eb468 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	...
	@${RM} ${OBJECTDIR}/main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -DRUN_HSM -I"../BeaconDetector.X" -I"../Movement.X" -I"../include" -I"../Indexer.X" -I"../scripts" -I"../Shooter.X" -I"../src" -I"../templates" -I"../UltrasonicPing.X" -I"../Movement.X" -MP -MMD -MF "${OBJECTDIR}/main.o.d" -o ${OBJECTDIR}/main.o main.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/main.o: main.c  .generated_files/flags/default/44ce81a17d430a5b74a9c6ad112bcd500f33b74e .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	...
	@${RM} ${OBJECTDIR}/main.o.d 
	@${RM} ${OBJECTDIR}/main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -DRUN_HSM -I"../BeaconDetector.X" -I"../Movement.X" -I"../include" -I"../Indexer.X" -I"../scripts" -I"../Shooter.X" -I"../src" -I"../templates" -I"../UltrasonicPing.X" -I"../Movement.X" -MP -MMD -MF "${OBJECTDIR}/main.o.d" -o ${OBJECTDIR}/main.o main.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
